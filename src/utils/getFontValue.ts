...
type fontTypes = "h1" | "h2" | "h3" | "h4" | "h5" | "h6";

export default function GetFontValue(variant: fontTypes) {
  const theme = useTheme();

  const breakpoints: Breakpoint | number = useWidth();
...
function useWidth() {
  ...
  return (
    keys.reduce((output: Breakpoint | null, key: any) => {
